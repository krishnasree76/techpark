...
export function Contact() {
  ...
  e.preventDefault()
    ...
    const phoneNumber = "917829070378"
...
Quality Requirements: ${formData.quality}
          ...
          <div className="rounded-lg border border-border bg-card p-8">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-5">
              ...
              <button
                ...
                className="flex items-center justify-between w-full px-4 py-3 border border-border rounded-md bg-muted text-sm font-medium"
              >
                For faster response, please share details
                <ChevronDown
              ...
              {/* Dropdown Content */}
              {open && (
                <div className="flex flex-col gap-4 p-4 border border-border rounded-md bg-background">
                  ...
                  <p className="text-sm text-muted-foreground">
                    ...
                    • Delivery timeline  
                    • Special quality requirements (if any)
                  </p>
                  ...
                  <input
                    ...
                    className="rounded-md border border-border bg-muted px-4 py-2 text-sm"
                  />
                  ...
                  <input
                    ...
                    type="text"
                    onChange={handleChange}
                    placeholder="Special Quality Requirements"
                    className="rounded-md border border-border bg-muted px-4 py-2 text-sm"
                  />
                </div>
              )}
              ...
              <textarea
                ...
                onChange={handleChange}
                placeholder="Describe your manufacturing requirements..."
                className="rounded-md border border-border bg-muted px-4 py-3 text-sm resize-none"
              />

              <button
                type="submit"
                className="rounded-md bg-primary px-6 py-3 text-sm font-semibold text-primary-foreground uppercase hover:bg-primary/90 transition-all"
              >
