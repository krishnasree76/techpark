...
//             <p className="text-sm leading-relaxed text-gray-700">
//               Precision CNC Machining & Integrated Manufacturing Solutions
//               for Aerospace, Automotive & Defence Industries.
//             </p>
//           </div>
    ...
    <footer className="relative border-t border-[var(--border)] bg-[var(--background)]">
      ...
      <div className="mx-auto max-w-7xl px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          {/* Navigation */}
          <div>
            <h4 className="text-sm font-semibold text-[var(--foreground)] uppercase tracking-wider mb-5">
              Navigation
            </h4>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <a
                  href="mailto:techpacktechnology.in@gmail.com"
                  className="text-sm text-[var(--foreground)]/80 hover:text-[var(--primary)] transition-colors break-all"
                >
                  techpacktechnology.in@gmail.com
                </a>
              </div>
